    ...
    <>
      <main id="main-content" tabIndex={-1} className="transition-main">
        <section className="container project-with-sidebar">
          <aside
            className="project-sidebar hidden md:h-screen md:sticky md:inset-y-0 md:left-0 md:flex md:flex-col sidebar-border"
            role="complementary"
          ...
          >
            <div className="flex flex-col justify-between flex-1 pt-8 ps-2 pe-7 min-w-0">
              <div className="sidebar-nav-cluster min-w-0">
                <nav
                  className="sidebar-section-nav flex flex-col gap-4 min-w-0 flex-1"
                  aria-label="On this page"
                >
                  <span className="sidebar-active-indicator" aria-hidden="true" />
                  <h4 className="break-words">
                    <button type="button" className="sidebar-link" data-section-target="#step1">
                      Context
                    </button>
                  </h4>
                  <h4 className="break-words">
                    <button type="button" className="sidebar-link" data-section-target="#step2">
                      Challenge
                    </button>
                  </h4>
                  <h4 className="break-words">
                    <button type="button" className="sidebar-link" data-section-target="#step3">
                      Solution
                    </button>
                  </h4>
                  <h4 className="break-words">
                    <button type="button" className="sidebar-link" data-section-target="#step4">
                      Final Products
                    </button>
                  </h4>
                  <h4 className="break-words">
                    <button type="button" className="sidebar-link" data-section-target="#step5">
                      Reflection
                    </button>
                  </h4>
                </nav>
          ...
          <div id="project-content" className="project-content space-y-8 mt-16 w-full">
            ...
            <div className="space-y-4" id="step1">
              ...
              <div className="space-y-4 content-width">
                ...
                <p>
                  I was assigned to work with a front-end developer to redesign Wiz Parser - an online interactive
                  teaching platform.The current developer had no system in place for creating new elements, instead
                  &quot;designing&quot; them as they were needed and trying to replicate what was already there.
                </p>
                <p>
                  I soon realized that this was more than just a visual redesign, but a core issue on how elemnts were
                  designed and developed.
                </p>
              </div>
            </div>
            <img
              src="/images/wizparser/Inconsistencies.png"
              alt="Inconsistencies"
            ...
            <div className="space-y-4" id="step2">
              ...
              <div className="space-y-4 ">
                <div className="important-bg space-y-8">
                  <div className="space-y-4">
                    ...
                    <h2>
                      How might we create a design system that allows developers to move to a whole other way of
                      designing elements?
                    </h2>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-4 bg-accent-1-muted p-4">
                      ...
                      <p>
                        There existed no system in place for developers to create new elements, instead trying to
                        replicate what the previous developer had done with no context.
                      </p>
                    </div>
                    <div className="space-y-4 bg-accent-2-muted p-4">
                      ...
                      <p>
                        ...
                        lacking visual and interaction consistency.
                      </p>
                    </div>
                    <div className="space-y-4 bg-accent-3-muted p-4">
                      <p className="caption-lg">Time Constraints</p>
                      <p>
                        Due to the time constraints of the developers, I had to work quickly and efficiently to create a
                        design system that would be easy to use and understand.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <div className="space-y-4" id="step3">
                  <div className="space-y-4">
                    ...
                    <div className="space-y-4 content-width">
                      ...
                      <p>
                        Previously, we had hourly check-ups, which caused a disconnect in the design process. However,
                        due to our short time span, both the deve and I had to this of communicating We switched to
                        Loom, enabling real-time visual updates without interrupting our workflow.
                      </p>
                    </div>
                    <img
                      src="/images/wizparser/wizparse_FigmaNotes.png"
                      alt="Final Assets"
                      className="greyborder my-4 full"
                    />
                  </div>
                  <div className="space-y-4 ">
                    <p>
                      From this, we were able to create a design strategy that would allow for a more efficient and
                      effective design process:
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="blank-bg">
                        <div className="caption-lg">Past Development Process</div>
                        <div className="space-y-4 h-full">
                          ...
                          <p>
                            2. Developers would try to figure out how to implement the element in the codebase from the
                            previous developer&apos;s code.
                          </p>
                          <div className="header-border" />
                          <p>
                            3. Most of production time would be spent on bug fixing and making sure the element is
                            working in the existing code space.
                          </p>
                          <div className="header-border" />
                          <p>
                            4. The final element would be added, despite not matching the quality of the rest of the
                            codebase.
                          </p>
                        </div>
                      </div>
                      <div className="solution-bg">
                        <div className="caption-lg">New Development Process</div>
                        <div className=" space-y-4 h-full">
                          <p>
                            1. Developers start by looking at the Wiz Parser design system, and see how they can use
                            the components to create a new element.
                          </p>
                          <div className="header-border" />
                          <p>
                            2. Developers have direct comments and instructions in the Figma file to help them implement
                            the element in the codebase, outlining typography spacing and breakpoints.
                          </p>
                          <div className="header-border" />
                          <p>
                            3. Developers can easily scale and onboard new team members with the design system and
                            documentation
                          </p>
                          <div className="header-border" />
                          <p>
                            4. The final element would be added, matching the quality of the rest of the codebase-
                ...
                <div className="space-y-4" id="step4">
                  ...
                  <div className="space-y-4">
                    <img className="greyborder my-4 full" src="/images/wizparser/FinalScreens.png" alt="Final screens" />
                ...
                <div className="space-y-4" id="step5">
                  ...
                  <div className="space-y-4 greyborder p-4 content-width">
                    ...
                    <p>
                      A good design system is more than just a set of guidelines. It&apos;s a tool that helps developers
                      create consistent, efficient, and maintainable code.
                    </p>
                  </div>
                  <div className="space-y-4 greyborder p-4 content-width">
                    <p className="caption-lg">2. Communicate Better, not More</p>
                    <p>
                      By sitting down with the developers and understanding their workflow, I was able to fully
                      understand their needs and understand how to design for them.
                    </p>
                  </div>
                  <div className="space-y-4 greyborder p-4 content-width">
                    <p className="caption-lg">3. Iterate Faster</p>
                    <p>
                      In a small company, every decision counts. By developing a back and forth process with the
                      developers, I was able to iterate faster and more efficiently.
                    </p>
                  </div>
                </div>
