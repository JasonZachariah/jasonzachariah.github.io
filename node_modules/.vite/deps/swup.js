...
async function u(t, e = {}) {
  ...
  const { url: g2 } = l.fromUrl(w2), v2 = { url: g2, html: f2 };
  return !n2.cache.write || e.method && "GET" !== e.method || t !== g2 || this.cache.set(v2.url, v2), v2;
}
var d = class {
  constructor(t) {
...
async function $({ selector: t, elements: e }) {
  ...
  const s2 = i2.map((t2) => function(t3) {
    const { type: e2, timeout: i3, propCount: s3 } = function(t4) {
      const e3 = window.getComputedStyle(t4), i4 = A(e3, `${U}Delay`), s4 = A(e3, `${U}Duration`), n2 = x(i4, s4), o2 = A(e3, `${P}Delay`), r2 = A(e3, `${P}Duration`), a2 = x(o2, r2), l2 = Math.max(n2, a2), h2 = l2 > 0 ? n2 > a2 ? U : P : null;
...
async function I(t, e = {}) {
  ...
  var h2, c2;
  "string" == typeof a2 && (t.animation.name = a2), t.meta = e.meta || {}, "object" == typeof e.cache ? (t.cache.read = null != (h2 = e.cache.read) ? h2 : t.cache.read, t.cache.write = null != (c2 = e.cache.write) ? c2 : t.cache.write) : void 0 !== e.cache && (t.cache = { read: !!e.cache, write: !!e.cache }), delete e.cache;
  try {
